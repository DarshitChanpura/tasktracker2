...
function update_buttons() {
  (0, _jquery2.default)(".manage-button").each(function (index, obj) {
    var user_id = (0, _jquery2.default)(obj).data('user-id');
    var manager_id = (0, _jquery2.default)(obj).data('manager');

    if (manager_id == "") {
      (0, _jquery2.default)(obj).text("Manage");
    } else {
      (0, _jquery2.default)(obj).text("Unmanage");
    }
  });
}
...
function set_button(user_id, manager_id) {
  (0, _jquery2.default)(".manage-button").each(function (index, obj) {
    if (user_id == (0, _jquery2.default)(obj).data('user-id')) {
      (0, _jquery2.default)(obj).data('manager', manager_id);
      update_buttons();
    }
  });
}
...
function unmanage(user_id, manager_id) {
  _jquery2.default.ajax(manage_path + "/" + manager_id, {
    method: "DELETE",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: "{}",
...
function manage_click(ev) {
  ...
  // record-id
  var manager_id = btn.data('manager');
...
function set_time_button(task_id, msg) {
  (0, _jquery2.default)(".timespent-button").each(function (index, obj) {
    if (task_id == (0, _jquery2.default)(obj).data('task-id')) {
      (0, _jquery2.default)(obj).data('isworking', msg);
      update_time_buttons();
    }
  });
}
...
function update_time_buttons() {
  (0, _jquery2.default)(".timespent-button").each(function (index, obj) {
    var task_id = (0, _jquery2.default)(obj).data('task-id');
    var isWorking = (0, _jquery2.default)(obj).data('isworking');

    if (isWorking == "yes") {
      (0, _jquery2.default)(obj).text("Stop");
    } else {
      (0, _jquery2.default)(obj).text("Start Working");
    }
  });
}
var start;
...
function stop_working(task_id, user_id, title, desc, completed) {
  ...
  _jquery2.default.ajax(timespent_path, {
    method: "POST",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: text,
...
function timespent_click(ev) {
  ...
  var user_id = btn.data('task-user-id');
  var title = btn.data('task-title');
  var desc = btn.data('task-desc');
  var completed = btn.data('task-comp');
  // let start-time = btn.data('task-start');
  // let end-time = btn.data('task-end');


  var isWorking = btn.data('isworking');
...
function init_timespent() {
  ...
  if (!(0, _jquery2.default)(".timespent-button")) {
    return;
  }

  (0, _jquery2.default)(".timespent-button").click(timespent_click);
...
(0, _jquery2.default)(init_timespent);
